...
//            $pages.= "<a class='first-page' href='".str_replace('__PAGE__',1,$url)."'>首页</a>";
//        }

        //上一页
        if ($upRow>0){
            $pages.=   "<a href='".str_replace('__PAGE__',$upRow,$url)."' class='pageturn'>".$this->config['prev']."</a>";
        }else{
...
//        }
        ...
        // for($i=$pmin; $i<=$pmax; $i++) {
        //     if($i==$this->nowPage) {
        //         $pages.= "<a class='current-page num'>".$i."</a>";
        //     }else{
        //         $pages.= "<a class='num' href='".str_replace('__PAGE__',$i,$url)."'>".$i."</a>";
        //     }
        // }
        $pages.="<div class=\"pagecount\"><label>".$this->nowPage."</label>/<label>".$this->totalPages."</label></div>";
...
//        }
        ...
        if ($downRow <= $this->totalPages){
            $pages.=   "<a href='".str_replace('__PAGE__',$downRow,$url)."' class='pageturn'>".$this->config['next']."</a>";
        }else{
...
//            $pages.= "<a class='last-page' href='".str_replace('__PAGE__',$this->totalPages,$url)."'>末页</a>";
//        }
