...
//				});
	...
	<?php $power=checkPower("PageLogView,DataBakView"); ?>
    <?php if(($power) == "1"): ?><dd>
			<div class="title">
				<span><img src="/phpstorehouse/Public/Admin/images/leftico01.png" /></span>安全管理
			</div>
			<ul class="menuson">
				<?php $power=checkPower("PageLogView"); if(($power) == "1"): ?><li><cite></cite><a href="<?php echo U('PageLog/index');?>" target="rightFrame">后台日志</a><i></i></li><?php endif; ?>

                <?php $power=checkPower("DataBakView"); if(($power) == "1"): ?><li><cite></cite><a href="<?php echo U('SysData/index');?>" target="rightFrame">数据备份</a><i></i></li><?php endif; ?>
