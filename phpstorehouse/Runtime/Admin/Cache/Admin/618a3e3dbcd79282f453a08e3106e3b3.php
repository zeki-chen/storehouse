...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <form action="<?php echo U('Jiedian/index1');?>" method="get">
            <ul class="toolbar1">
                <li>关键词：
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                ...
                <td><?php echo ($item["wendu1"]); ?></td>
                <td><?php echo ((isset($item["shidu1"]) && ($item["shidu1"] !== ""))?($item["shidu1"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["guangzhao1"]) && ($item["guangzhao1"] !== ""))?($item["guangzhao1"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["fire1"]) && ($item["fire1"] !== ""))?($item["fire1"]):'未填写'); ?></td>
