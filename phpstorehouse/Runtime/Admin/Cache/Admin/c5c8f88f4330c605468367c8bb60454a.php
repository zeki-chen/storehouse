...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('User/doEdit');?>">
        <input type="hidden" name="us_id" value="<?php echo ($model["us_id"]); ?>"/>
        ...
        <div class="     ">
            ...
            <div class="tab mt10" id="tabid1">
                <table class="formtable ">
                    ...
                    <tr id="" class="" ><td class="ft_title">操作员名称</td><td colspan="3"><input value="<?php echo ($model["us_name"]); ?>" name="us_name" type="text"   id="_input"   datatype="*"   errormsg="该用户名已被占用"    class="bds inp  w200" nullmsg="请填写操作员名称"  placeholder="请填写操作员名称"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写操作员名称</span></td></tr>


                    <tr id="" class="" ><td class="ft_title">地址</td><td colspan="3"><input value="<?php echo ($model["us_address"]); ?>" name="us_address" type="text"   id="_input"    class="bds inp  w200" nullmsg="请填写地址(选填)"  placeholder="请填写地址(选填)"/><font class="need show_0">  </font><span class="Validform_checktip">请填写地址(选填)</span></td></tr>

                    <tr id="" class="" ><td class="ft_title">手机号码</td><td colspan="3"><input value="<?php echo ($model["us_phone"]); ?>" name="us_phone" type="text"   id="_input"   datatype="m"   errormsg="请填写正确的手机号码"    ignore="ignore"    class="bds inp  w200" nullmsg="请填写手机号码(选填)"  placeholder="请填写手机号码(选填)"/><font class="need show_0">  </font><span class="Validform_checktip">请填写手机号码(选填)</span></td></tr>

                    <tr>
                        <td class="ft_title">用户状态</td>
                        <td colspan="3">
                            <?php if(($model["us_status"]) == "1"): ?><input type="radio" name="us_status" value="1" checked>有效
                                <input type="radio" name="us_status" value="0">无效
                                <?php else: ?>
                                <input type="radio" name="us_status" value="1">有效
                                <input type="radio" name="us_status" value="0" checked>无效<?php endif; ?>
                        </td>
                    </tr>
                    <tr>
                        <td></td>
