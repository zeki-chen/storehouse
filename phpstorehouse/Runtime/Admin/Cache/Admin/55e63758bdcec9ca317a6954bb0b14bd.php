...
//				});
    ...
    <?php $power=checkPower("AdminView,AdminRoleView,AdminPowerView"); ?>
    <?php if(($power) == "1"): ?><dd>
            <div class="title">
                <span><img src="/phpstorehouse/Public/Admin/images/leftico01.png" /></span>系统管理员
            </div>
            <ul class="menuson">
                <?php $power=checkPower("AdminView"); if(($power) == "1"): ?><li><cite></cite><a href="<?php echo U('Admin/index');?>" target="rightFrame">管理员管理</a><i></i></li><?php endif; ?>
                <?php $power=checkPower("AdminRoleView"); if(($power) == "1"): ?><li><cite></cite><a href="<?php echo U('AdminRole/index');?>" target="rightFrame">角色管理</a><i></i></li><?php endif; ?>
                <?php $power=checkPower("AdminPowerView"); if(($power) == "1"): ?><li><cite></cite><a href="<?php echo U('AdminPower/index');?>" target="rightFrame">权限代码管理</a><i></i></li><?php endif; ?>
            </ul>
        </dd><?php endif; ?>
