...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('Stock/doEdit');?>">
        <input type="hidden" name="sti_id" value="<?php echo ($model["sti_id"]); ?>" />
    ...
    <div class="tab mt10" id="tabid1">
        <table class="formtable ">
          ...
          <tr>
            ...
            <tr id="" class="" ><td class="ft_title">货单总价</td><td colspan="3"><input value="<?php echo ($model["sti_worth"]); ?>" name="sti_worth" type="text"   maxlength="2"    id="_input"   datatype="zs"   class="bds inp  w100" nullmsg="请填写货单总价"  placeholder="请填写货单总价"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写货单总价</span></td></tr>
    ...
    <div class="tab mt10" id="tabid1">
        <table class="formtable ">
            <tbody>
              ...
              <td class="ft_title">商品编号</td>
              <td>
                <?php echo ($vo["go_id"]); ?>
              </td>
              </tr>
              <tr>
              <td class="ft_title">商品名</td>
              <td>
                <?php echo ($vo["go_name"]); ?>
              </td>
              </tr>
              <tr>
              <td class="ft_title">商品数量</td>
              <td>
                <?php echo ($vo["sti_num"]); ?>
              </td>
              </tr>
               <tr>
              <td class="ft_title">商品单价</td>
              <td>
                <?php echo ($vo["go_price"]); ?>
              </td>
