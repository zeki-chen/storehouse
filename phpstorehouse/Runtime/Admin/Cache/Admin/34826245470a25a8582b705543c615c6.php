...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('Warehouse/doEdit');?>">
        <input type="hidden" name="wa_id" value="<?php echo ($model["wa_id"]); ?>" />
...
<div class="     ">
    ...
    <div class="tab mt10" id="tabid1">
        ...
        <tr id="" class="" ><td class="ft_title">仓库名</td><td colspan="3"><input value="<?php echo ($model["wa_name"]); ?>" name="wa_name" type="text"   maxlength="6"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写仓库名"  placeholder="请填写仓库名"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写仓库名</span></td></tr>
           <tr id="" class="" ><td class="ft_title">仓库地址</td><td colspan="3"><input value="<?php echo ($model["wa_address"]); ?>" name="wa_address" type="text"   maxlength="6"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写仓库地址"  placeholder="请填写仓库地址"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写仓库地址</span></td></tr>
          <tr id="" class="" ><td class="ft_title">仓库容量</td><td colspan="3"><input value="<?php echo ($model["wa_size"]); ?>" name="wa_size" type="text"   maxlength="6"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写仓库容量"  placeholder="请填写仓库容量"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写仓库容量</span></td></tr> 
