...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                <td>
                    <input type="checkbox" value="<?php echo ($item["score_id"]); ?>" class="del_checkbox" />
                </td>
                ...
                <td>
                    <a href="<?php echo U('Score/edit',array('score_id'=>$item['score_id']));?>" class="tablelink">编辑</a> &nbsp;|&nbsp;

                    <a class="delBtn tablelink" href="<?php echo U('Score/doDel',array('ids'=>$item['score_id']));?>"
