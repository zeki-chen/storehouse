...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            <li class="click">
                <a href="<?php echo U('Stock/add_out');?>">
                    <span><img src="/phpstorehouse/Public/Admin/images/t01.png"/></span>添加</a>
            </li>
            <li class="click">
                <a href="javascript:delMut('<?php echo U(" Stock/doDel_out");?>')">
                <span><img src="/phpstorehouse/Public/Admin/images/t03.png"/></span>删除</a>
            </li>

        </ul>

        <form action="<?php echo U('Stock/index_out');?>" method="get">
            <ul class="toolbar1">
                <li>关键词：
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                <td>
                    <input type="checkbox" value="<?php echo ($item["sto_id"]); ?>" class="del_checkbox"/>
                </td>
                ...
                <td>
                    <a href="<?php echo U('Stock/edit_out',array('student_id'=>$item['sto_id']));?>" class="tablelink">编辑</a>
                    &nbsp;|&nbsp;


                    <a class="delBtn tablelink" href="<?php echo U('Stock/doDel_out',array('ids'=>$item['sto_id']));?>"
