...
<div class="rightinfo">
    ...
    <div class="tools">
        ...
        <form action="<?php echo U('Jiedian/index2');?>" method="get">
            <ul class="toolbar1">
                <li>关键词：
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                ...
                <td><?php echo ($item["wendu2"]); ?></td>
                <td><?php echo ((isset($item["shidu2"]) && ($item["shidu2"] !== ""))?($item["shidu2"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["guangzhao2"]) && ($item["guangzhao2"] !== ""))?($item["guangzhao2"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["fire2"]) && ($item["fire2"] !== ""))?($item["fire2"]):'未填写'); ?></td>
