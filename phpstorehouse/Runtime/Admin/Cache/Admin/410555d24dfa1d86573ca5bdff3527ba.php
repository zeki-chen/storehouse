...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('User/doPwd');?>">
        <input type="hidden" name="us_id" value="<?php echo ($model["us_id"]); ?>" />
        <input type="hidden" name="us_name" value="<?php echo ($model["us_name"]); ?>" />
        ...
        <div class="     ">
            ...
            <div class="tab mt10" id="tabid1">
                <table class="formtable ">
                    <tbody>
                    <tr>
                        <td class="ft_title">操作员id</td>
                        <td><?php echo ($model["us_id"]); ?></td>
                    </tr>
                    <tr>
                        <td class="ft_title">操作员姓名</td>
                        <td><?php echo ($model["us_name"]); ?></td>
                    </tr>

                    <tr id="" class="" ><td class="ft_title">密码</td><td colspan="3"><input value="" name="us_password" type="password"   id="_input"   datatype="*6-18"   class="bds inp  w200" nullmsg="请填写密码"  placeholder="请填写密码"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写密码</span></td></tr>

                    <tr id="" class="" ><td class="ft_title">确认密码</td><td colspan="3"><input value="" name="" type="password"   id="_input"   datatype="*6-18"  recheck="us_password"   class="bds inp  w200" nullmsg="请填写确认密码"  placeholder="请填写确认密码"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写确认密码</span></td></tr>
