...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                ...
                <td class="tl"><?php echo ($item["sto_id"]); ?></td>
                <td><?php echo ($item["wa_id"]); ?></td>
                <td><?php echo ((isset($item["us_id"]) && ($item["us_id"] !== ""))?($item["us_id"]):'未填写'); ?></td>
              
                <td><?php echo ((isset($item["sto_worth"]) && ($item["sto_worth"] !== ""))?($item["sto_worth"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["sto_time"]) && ($item["sto_time"] !== ""))?($item["sto_time"]):'未填写'); ?></td>
                <td><?php echo ($item["sto_remark"]); ?></td>
                <td>
                    <a href="<?php echo U('Stock/edit',array('student_id'=>$item['sto_id']));?>" class="tablelink">编辑</a> &nbsp;|&nbsp;


                    <a class="delBtn tablelink" href="<?php echo U('Stock/doDel',array('ids'=>$item['sto_id']));?>"
