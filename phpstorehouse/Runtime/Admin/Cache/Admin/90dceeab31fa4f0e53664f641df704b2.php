...
<div class="p10">
    <form class="mainform" action="<?php echo U('ArtClass/doEdit',array('model_id'=>$model_id));?>" method="post">
        <input type="hidden" name="model_id" value="<?php echo ($model_id); ?>"/>
        <input type="hidden" name="cid" value="<?php echo ($model["cid"]); ?>" />
...
<div class="     ">
    ...
    <div class="tab mt10" id="tabid1">
        <table class="formtable ">
            <tbody>
            <tr id="" class="" ><td class="ft_title">分类名称</td><td colspan="3"><input value="<?php echo ($model["class_name"]); ?>" name="class_name" type="text"   id="_input"   datatype="*"   class="bds inp  w200" nullmsg="请填写分类名称"  placeholder="请填写分类名称"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写分类名称</span></td></tr>

            <?php if(($model_id) == "21"): ?><tr>
                    <td class="ft_title">图片</td>
                    <td>
                        <div class="uploaderPic"><div class="uploader-list" id="pic"><?php if(is_array($model['pic'])): foreach($model['pic'] as $k=>$vo): ?><div id="" class="item"><img src="<?php echo ($vo['path']); ?>" width="100" height="100"><span class="info"><?php echo ($vo["name"]); ?></span><div class="picTool"><span class="iconfont delPic">&#xe60a;</span></div><span class="success"></span><input type="hidden" name="pic[<?php echo ($k); ?>][path]" value="<?php echo ($vo["path"]); ?>"><input type="hidden" name="pic[<?php echo ($k); ?>][name]" value="<?php echo ($vo["name"]); ?>"></div><?php endforeach; endif; ?></div><div class="picAdd div_addbtn"><div id="picbtn"></div></div><div class="countTip"></div><input type="text" style="width:1px;height:1px;display:inline" value="0" datatype="file" nullmsg="请上传图片" errormsg="请上传图片"/><div class="tips"></div></div><script type="text/javascript">var uploadswf="/xfzz/web/Public/webuploader-0.1.5/Uploader.swf";var uploadphp="/xfzz/web/admin.php/Webuploader/upload.html";</script><script type="text/javascript" src="/xfzz/web/Public/Admin/js/webUploadPicYcF.v2.js"></script><script type="text/javascript">var upload=new ycUploadPic({"1":"pic","inputName":"pic","sumsize":"2","pick_id":"#picbtn","id":"#pic","singlesize":"2","count":"1","compress":"1"});</script>
                    </td>
                </tr><?php endif; ?>

            <tr id="" class="" ><td class="ft_title">跳转链接</td><td colspan="3"><input value="<?php echo ($model["link_url"]); ?>" name="link_url" type="text"   id="_input"    class="bds inp  w500" nullmsg="请填写跳转链接(选填)"  placeholder="请填写跳转链接(选填)"/><font class="need show_0">  </font><span class="Validform_checktip">请填写跳转链接(选填)</span></td></tr>

            <tr id="" class="" ><td class="ft_title">排序</td><td colspan="3"><input value="<?php echo ((isset($model["sort"]) && ($model["sort"] !== ""))?($model["sort"]):99); ?>" name="sort" type="text"   id="_input"   datatype="*"   class="bds inp  w200" nullmsg="请填写排序"  placeholder="请填写排序"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写排序</span></td></tr>
