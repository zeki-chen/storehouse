				...
				<input type="hidden" name="code" value="<?php echo ($model["code"]); ?>" />
					...
					<div class="tab mt10" id="tabid1">
						<table class="formtable ">
							<tbody>
								<input type="hidden" name="code" value="api" />
								<tr id="" class="" ><td class="ft_title">微信AUTH地址</td><td colspan="3"><input value="<?php echo ($model["wxurl"]); ?>" name="wxurl" type="text"   maxlength="1000"    id="_input"    class="bds inp  w300" nullmsg="请填写微信AUTH网址"  placeholder="请填写微信AUTH网址"/><font class="need show_0">  </font><span class="Validform_checktip">请填写微信AUTH网址</span></td></tr>

								<tr id="" class="" ><td class="ft_title">微信api用户名</td><td colspan="3"><input value="<?php echo ($model["wxappuser"]); ?>" name="wxappuser" type="text"   maxlength="50"    id="_input"    class="bds inp  w300" nullmsg="请填写微信api用户名"  placeholder="请填写微信api用户名"/><font class="need show_0">  </font><span class="Validform_checktip">请填写微信api用户名</span></td></tr>
								<tr>
									<td></td>
									<td colspan="3">
