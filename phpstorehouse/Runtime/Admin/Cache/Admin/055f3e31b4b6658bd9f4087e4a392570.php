...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            <li class="click">
                <a href="<?php echo U('Manufacturer/add');?>">
                    <span><img src="/phpstorehouse/Public/Admin/images/t01.png"/></span>添加</a>
            </li>
            <li class="click">
                <a href="javascript:delMut('<?php echo U(" Manufacturer/doDel");?>')">
                <span><img src="/phpstorehouse/Public/Admin/images/t03.png"/></span>删除</a>
            </li>
        </ul>

        <form action="<?php echo U('Manufacturer/index');?>" method="get">
            <ul class="toolbar1">
                <li>关键词：
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th width="100">生产商地址</th>
            <th width="100">生产商电话</th>
            <th width="200">操作</th>
        </tr>
        </thead>
        <tbody>
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                ...
                <td class="tl"><?php echo ($item["ma_id"]); ?></td>
                <td><?php echo ($item["ma_name"]); ?></td>
                <td><?php echo ((isset($item["ma_phone"]) && ($item["ma_phone"] !== ""))?($item["ma_phone"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["ma_address"]) && ($item["ma_address"] !== ""))?($item["ma_address"]):'未填写'); ?></td>
                <td>
                    <a href="<?php echo U('Manufacturer/edit',array('student_id'=>$item['ma_id']));?>" class="tablelink">编辑</a>
                    &nbsp;|&nbsp;


                    <a class="delBtn tablelink" href="<?php echo U('Manufacturer/doDel',array('ids'=>$item['ma_id']));?>"
