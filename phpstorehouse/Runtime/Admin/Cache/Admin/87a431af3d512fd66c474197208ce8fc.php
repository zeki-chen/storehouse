...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('Manufacturer/doAdd');?>">
...
<div class="     ">
    ...
    <div class="tab mt10" id="tabid1">
        ...
        <tr id="" class="" ><td class="ft_title">经销商名</td><td colspan="3"><input value="<?php echo ($model["ma_name"]); ?>" name="ma_name" type="text"   maxlength="10"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写经销商名"  placeholder="请填写经销商名"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写经销商名</span></td></tr>
           <tr id="" class="" ><td class="ft_title">经销商地址</td><td colspan="3"><input value="<?php echo ($model["ma_address"]); ?>" name="ma_address" type="text"   maxlength="30"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写经销商地址"  placeholder="请填写经销商地址"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写经销商地址</span></td></tr>
          <tr id="" class="" ><td class="ft_title">经销商电话</td><td colspan="3"><input value="<?php echo ($model["ma_phone"]); ?>" name="ma_phone" type="text"   maxlength="20"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写经销商电话"  placeholder="请填写经销商电话"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写经销商电话</span></td></tr> 
