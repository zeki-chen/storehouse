...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            <li class="click">
                <a href="<?php echo U('Nav/add');?>">
                    <span><img src="/storehouse/Public/Admin/images/t01.png" /></span>添加</a>
            </li>
            <li class="click">
                <a href="javascript:delMut('<?php echo U("Nav/doDel");?>')">
                <span><img src="/storehouse/Public/Admin/images/t03.png" /></span>删除</a>
            </li>
            <li class="click" style="width: 96px;">
                <a href="javascript:void(0)" onclick="updateNav()">
                <span><img src="/storehouse/Public/Admin/images/ico04.png" /></span>更新导航栏</a>
            </li>
        </ul>

        <form action="<?php echo U('Nav/index');?>" method="get">
            <ul class="toolbar1">
                <li>关键词：
    ...
    <table class="tablelist">
        ...
        <tr>
            ...
            <th width="200" class="tl">导航名称</th>
            <th width="400">跳转链接</th>
            <th width="50">是否显示</th>
            <th width="50">排序</th>
            <th width="150">操作</th>
        </tr>
        ...
        <tbody>
        <?php if(is_array($list)): foreach($list as $key=>$item): ?><tr><input class="id" type="hidden" name="nid" value="<?php echo ($item["nid"]); ?>"/>
                <td>
                    <input type="checkbox" value="<?php echo ($item["nid"]); ?>" class="del_checkbox" />
                </td>
                <td class="tl yc_edit_g">
                    <span name="title"><?php echo ($item["title"]); ?></span>
                </td>
                <td class="yc_edit">
                ...
                <td>
                    <a href="<?php echo U('Nav/add',array('pid'=>$item['nid']));?>" class="tablelink">添加子导航</a> &nbsp;|&nbsp;
                    <a href="<?php echo U('Nav/edit',array('nid'=>$item['nid']));?>" class="tablelink">编辑</a> &nbsp;|&nbsp;
                    <a class="delBtn tablelink" href="<?php echo U('Nav/doDel',array('ids'=>$item['nid']));?>" del_title="<?php echo ($item["title"]); ?>">删除</a>
                </td>
...
<script type="text/javascript">
    ...
    function updateNav(){
        var layerIndex=loading("处理中...");
        var updateUrl="<?php echo U('Nav/updateNav');?>";
...
<?php $power=checkPower("NavEdit"); if(($power) == "1"): ?><script type="text/javascript">
