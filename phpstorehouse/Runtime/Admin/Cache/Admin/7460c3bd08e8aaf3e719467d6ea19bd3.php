...
<div class="rightinfo">
    ...
    <div class="tools">
        <ul class="toolbar">
            ...
            <li class="click">
                <a href="javascript:delMut('<?php echo U(" Goods/doDel");?>')">
    ...
    <table class="tablelist">
        ...
        <?php if(is_array($list)): foreach($list as $k=>$item): ?><tr>
                <td>
                    <input type="checkbox" value="<?php echo ($item["go_id"]); ?>" class="del_checkbox"/>
                </td>
                <td class="tl"><?php echo ($item["go_id"]); ?></td>
                <td><?php echo ($item["go_name"]); ?></td>
                <td><?php echo ((isset($item["go_engname"]) && ($item["go_engname"] !== ""))?($item["go_engname"]):'未填写'); ?></td>

                <td><?php echo ((isset($item["go_size"]) && ($item["go_size"] !== ""))?($item["go_size"]):'未填写'); ?></td>
                <td><?php echo ((isset($item["go_price"]) && ($item["go_price"] !== ""))?($item["go_price"]):'未填写'); ?></td>
                <td><?php echo ($item["ma_name"]); ?></td>
                <td>
                    <a href="<?php echo U('Goods/edit',array('student_id'=>$item['go_id']));?>" class="tablelink">编辑</a> &nbsp;|&nbsp;


                    <a class="delBtn tablelink" href="<?php echo U('Goods/doDel',array('ids'=>$item['go_id']));?>"
