...
<script>
	...
	<a href="javascript:history.go(-1)" class="goback">返回</a>
		...
		<div class="p10">
			<form class="mainform" role="form" method="post" action="<?php echo U('Admin/doPsw');?>">
					...
					<div class="tab mt10" id="tabid1">
						<table class="formtable ">
							<tbody>
								...
								<tr id="" class="" ><td class="ft_title">密码</td><td colspan="3"><input value="" name="pwd" type="password"   id="_input"   datatype="*6-18"   class="bds inp  w200" nullmsg="请填写密码"  placeholder="请填写密码"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写密码</span></td></tr>

								<tr id="" class="" ><td class="ft_title">确认密码</td><td colspan="3"><input value="" name="" type="password"   id="_input"   datatype="*6-18"  recheck="pwd"   class="bds inp  w200" nullmsg="请填写确认密码"  placeholder="请填写确认密码"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写确认密码</span></td></tr>
