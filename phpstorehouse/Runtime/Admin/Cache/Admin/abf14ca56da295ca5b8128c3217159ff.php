...
<div class="p10">
    <form class="mainform" role="form" method="post" action="<?php echo U('Stock/doAdd');?>">
    ...
    <div class="tab mt10" id="tabid1">
        <table class="formtable ">
           ...
           <tr>
            ...
            <tr id="" class="" ><td class="ft_title">货单总价</td><td colspan="3"><input value="<?php echo ($model["sti_worth"]); ?>" name="sti_worth" type="text"   maxlength="10"    id="_input"   datatype="zs"   class="bds inp  w100" nullmsg="请填写货单总价"  placeholder="请填写货单总价"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写货单总价</span></td></tr>

            <tr id="" class="" ><td class="ft_title">入库时间</td><td colspan="3"><input value="<?php echo ($model["sti_time"]); ?>" name="sti_time" type="text"   id="_input"    onclick="WdatePicker()"   datatype="*"   class="bds inp  w100 Wdate" nullmsg="请填写入库时间"  placeholder="请填写入库时间"/><font class="need show_0"> * </font><span class="Validform_checktip">请填写入库时间</span></td></tr>
            <tr id="" class="" ><td class="ft_title">备注</td><td colspan="3"><textarea  name="sti_remarks" type="text"    placeholder="请填写备注" maxlength="250"   id="_input"    class="bds inp  w400 h80" nullmsg="请填写备注"  ><?php echo ($model['sti_remarks']); ?></textarea><font class="need show_0">  </font><span class="Validform_checktip">请填写备注</span></td></tr>
    ...
    <div class="tab mt10" id="tabid1">
        <table class="formtable ">
           ...
           <tr id="" class="" ><td class="ft_title">商品编号</td><td colspan="3"><input value="" name="go_id1" type="text"   maxlength="20"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="商品编号"  placeholder="商品编号"/><font class="need show_0">  </font><span class="Validform_checktip">商品编号</span></td></tr>
            <tr id="" class="" ><td class="ft_title">商品数量</td><td colspan="3"><input value="" name="sti_num1" type="text"   maxlength="20"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="请填写商品数量"  placeholder="请填写商品数量"/><font class="need show_0">  </font><span class="Validform_checktip">请填写商品数量</span></td></tr>
             </tbody> 
     ...
     function getData() {
            $ht =
                              '<tr id="" class="" ><td class="ft_title">商品编号</td><td colspan="3"><input value="<?php echo ($vo["go_id"]); ?>" name="go_id'+n+'" type="text"   maxlength="20"    id="_input"   datatype="*"   class="bds inp  w100" nullmsg="商品编号"  placeholder="商品编号"/><font class="need show_0">  </font><span class="Validform_checktip">商品编号</span></td></tr> '+
                               ' <tr id="" class="" ><td class="ft_title">商品数量</td><td colspan="3"><input value="<?php echo ($vo["sti_num"]); ?>" name="sti_num'+n+'" type="text"   maxlength="20"    id="_input"    class="bds inp  w100" nullmsg="请填写商品数量"  placeholder="请填写商品数量"/><font class="need show_0">  </font><span class="Validform_checktip">请填写商品数量</span></td></tr>'
                            $("#add").append($ht);
                            $("#n").append().val(n);
                            n=n+1;
