...
<script type="text/javascript" src="/xfzz/web/Public/Validform_v5.3.2/js/Validform_v5.3.2_min.js"></script>
		<link rel="stylesheet" type="text/css" href="/xfzz/web/Public/Index/css/list.css" />
	</head>
					...
					<div class="essay_list">
						<ul>
							<?php if(is_array($list)): foreach($list as $key=>$item): ?><li>
									<a href="<?php echo U('Details/index',array('aid'=>$item[aid]));?>" target="_blank" class="clearFloat"
                                       title="$item.title">
										<span class="title"><?php echo ($item["title"]); ?></span>
										<span class="date"><?php echo (date("Y年m月d日",$item["pubdate"])); ?></span>
									</a>
								</li><?php endforeach; endif; ?>
						</ul>
					</div>
