...
<script type="text/javascript" src="/xfzz/web/Public/Validform_v5.3.2/js/Validform_v5.3.2_min.js"></script>
		<link rel="stylesheet" type="text/css" href="/xfzz/web/Public/Index/css/search.css" />
	</head>
    ...
    <script type="text/javascript">
		...
		<div class="minute">
			<div class="public_container clearFloat">
				<div class="list_box">
					<div class="keyword">
						<div class="tip">搜索关键词：“<span class="red"><?php echo ($keyword); ?></span>”</div>
					</div>
					<div class="search_list">
						<ul>
							<?php if(is_array($res)): foreach($res as $key=>$item): ?><li>
									<a href="<?php echo U('Details/index',array('aid'=>$item['aid']));?>" class="clearFloat" title="$item.title">
										<span class="title"><?php echo ($item["title"]); ?></span>
										<span class="date"><?php echo (date("Y-m-d",$item["pubdate"])); ?></span>
									</a>
								</li><?php endforeach; endif; ?>
						</ul>
					</div>
